    ...
    <div className="pt-20 bg-gray-50 min-h-screen">
      {cart?.items?.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
          ...
          <p className="mt-2 text-gray-600">Looks like you haven't added to your cart yet</p>
          <Button onClick={()=>navigate("/products")} className = "mt-6 bg-pink-600 text-white hover:bg-pink-700">Start Shopping</Button>
        </div>
      )}
    </div>
  );
